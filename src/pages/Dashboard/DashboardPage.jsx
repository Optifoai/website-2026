...
import { displayDateFormat, EMPTY_ARRAY, EMPTY_OBJECT, notify, ResponseFilter } from '../../utils/helpers';
...
function DashboardPage(props) {
    ...
    const actioneditModal = () => {
        console.log('actioneditModal model')
    }
                ...
                {/* car image downlaod model */}
                 ...
                 {/* car Edit downlaod model */}
                  <CommonModel show={formdata.editModelOpen} onClose={() => {setFormdata({ editModelOpen: false })}}>
                    ...
                    <div className='popup-btn'>
                        <button type="button" class="btn btn-login" onClick={actioneditModal}>{t('UpdateText')}</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onClick={ () => {setFormdata({ editModelOpen: false });}}>{t('cancelText')}</button>
                    </div>                   
