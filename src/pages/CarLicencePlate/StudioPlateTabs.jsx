...
function StudioPlateTabs(props) {
            ...
            >
                ...
                <Tab eventKey="3" >
                    <div className="account-tab">
                        ...
                        <div className="">
                            <button onClick={() => saveCarDetails()} type="button" className=" buy-btn position-static">Save</button>
                        </div>
                    </div>
                </Tab>
...
export default connect(mapStateToProps)(StudioPlateTabs);