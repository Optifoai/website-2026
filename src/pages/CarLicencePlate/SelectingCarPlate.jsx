...
function SelectingCarPlate(props) {
    const { selectedImages, imageDetails, handleImagePositionChange, handleDeleteCar, updateCarImage,handleGoToNewCar } = props;
...
export default connect(mapStateToProps)(SelectingCarPlate)