...
import CreateCarPlateForm from './CreateCarPlateForm';
import MultipalUploadPage from '../../components/common/UploadPage/MultipalUploadPage';

function CarLicencePlate(props) {
...
CarLicencePlate.propTypes = {
    loader: PropTypes.bool,
    userDetails: EMPTY_OBJECT,
}

CarLicencePlate.defaulProps = {
    userDetails: EMPTY_OBJECT,
    loader: PropTypes.bool,
}
...
export default connect(mapStateToProps)(CarLicencePlate)